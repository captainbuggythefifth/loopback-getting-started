...
/**
 * @ngdoc object
 * @name lbServices.Breakfast
 * @header lbServices.Breakfast
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Breakfast` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/BreakfastSpots/:id",
      { 'id': '@id' },
      {

        /**
         * @ngdoc method
         * @name lbServices.Breakfast#create
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Breakfast` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/BreakfastSpots",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Breakfast#createMany
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Breakfast#upsert
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Breakfast#exists
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/BreakfastSpots/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Breakfast#findById
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/BreakfastSpots/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Breakfast#find
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Breakfast#findOne
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/BreakfastSpots/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Breakfast#updateAll
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/BreakfastSpots/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Breakfast#deleteById
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Breakfast#count
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/BreakfastSpots/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Breakfast#prototype$updateAttributes
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Breakfast#createChangeStream
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/BreakfastSpots/change-stream",
          method: "POST"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Breakfast#updateOrCreate
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Breakfast#update
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Breakfast#destroyById
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Breakfast#removeById
         * @methodOf lbServices.Breakfast
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Breakfast#modelName
    * @propertyOf lbServices.Breakfast
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Breakfast`.
    */
    R.modelName = "Breakfast";
